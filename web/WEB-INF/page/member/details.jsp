                ...
                <div class="mainContent" >  
                    ...
                    <div class="center hasImg">
                        <div class="message">
                            ...
                            <p>专业：${obj.member.extend.major}</p>
                        ...
                        <div class="message">
                            <h2>正在参与项目</h2>
                            <c:forEach items="${obj.developing}" var="project">
                                <p>${project.name} <a href="${base}/project/${project.id}" >详情</a></p>
                            </c:forEach>         
                        </div>
                        <div class="message">
                            <h2>完成项目</h2>
                            <c:forEach items="${obj.finished}" var="project">
                                <p>${project.name} <a href="${base}/project/${project.id}" >详情</a></p>
                            </c:forEach>                    
                        </div>
                    </div>

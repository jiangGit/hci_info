                ...
                <div class="mainContent">      		
                    <div class="center">
                        <div class="message">
                            ...
                            <p>部门名：<input type="text" name="department.name"></p>                            
                            <p>简介：</p>
                            <textarea rows="4" cols="20" name="department.detail" style="width: 100%;" ></textarea>
                            <input type="hidden" name="token" value="${token}">
                            </form>
                        </div>
                        <button class="button" onclick="addDepartment()" >保存</button>
                    </div>
                </div>

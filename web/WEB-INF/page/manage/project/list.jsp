...
<html>
    ...
    <body>
                ...
                <div class="filter">
                    <form  id="filter" action="#" method="post" >
                        ...
                        <select name="state"  class="filterSelect">
                            ...
                            <option value="3" ${obj.condition.state== 3?"selected=\"selected\"":"" }>难产</option>
                        </select>
                        ...
                        <c:forEach items="${obj.list}" var="project" varStatus="status">
                            <div class="project">
                                ...
                                <div class="controls">
                                    ...
                                    <a href="${project.id}">编辑</a> |
                                    <a href="members/${project.id}">人员更改</a> |
                                    <a href="javascript:void(0);" class="finished_project" >结题</a>|
                                    <a href="javascript:void(0);" class="remove_project" >移除</a>
                                </div>
                                <div class="clear"></div>
                            </div>
                        </c:forEach>
        ...
        <script>
            $(function(){
                $(".finished_project").click(toFinishedProject);
                $(".remove_project").click(toRemoveProjct);
            });
        </script>
    </body>
</html>
